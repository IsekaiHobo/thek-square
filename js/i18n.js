...
(function () {
  ...
  var translations = {
    en: {
      ...
      'footer.phone': 'Phone: +63 (placeholder)',

      /* ---- Home: hero ---- */
      'home.title': 'The K-Square — Where Korea Comes Alive in Olongapo',
      'hero.eyebrow': 'Olongapo · Zambales · Pre-construction',
      'hero.title': 'The K-Square',
      'hero.tagline': 'Where Korea comes alive in Olongapo — a four-floor destination for beauty, food, and entertainment.',
      'hero.cta': 'Discover the Vision',
      'hero.scroll': 'Scroll',

      /* ---- Home: vision ---- */
      'vision.eyebrow': '01 — The Vision',
      ...
      'floor2.body': 'Hair salon, nail art, massage, Atomy Center, beauty booths, Korean Daiso, and parcel delivery — an immersive space for Korea’s finest beauty and healthcare.',
      ...
      'floor3.body': 'A food court spanning Chinese, Japanese, Ramyun, Chicken, Bibimbap, Hansik, Samgyupsal, and Jjigae stalls, plus a beverage bar — gourmet cuisine in K-drama-inspired scenery.',
      ...
      'fork.brands.eyebrow': 'For Brands',
      ...
      'fork.investors.eyebrow': 'For Investors',
      ...
      'leasing.floors.eyebrow': '02 — The Floors',
      ...
      /* ---- Investing ---- */
      'investing.title': 'Investing — The K-Square',
      ...
      'investing.opp.eyebrow': '01 — The Opportunity',
      ...
      'contact.details': 'hello@thek-square.ph · +63 (placeholder)',
    ...
    ko: {
      ...
      'footer.phone': '전화: +63 (추후 안내)',

      /* ---- Home: hero ---- */
      'home.title': '더 케이스퀘어 — 올롱가포에서 만나는 한국',
      'hero.eyebrow': '올롱가포 · 잠발레스 · 착공 예정',
      'hero.title': '더 케이스퀘어',
      'hero.tagline': '올롱가포에서 한국이 살아나는 곳 — 뷰티, 푸드, 엔터테인먼트를 아우르는 4층 복합 공간입니다.',
      'hero.cta': '비전 살펴보기',
      'hero.scroll': '스크롤',

      /* ---- Home: vision ---- */
      'vision.eyebrow': '01 — 비전',
      ...
      'floor2.body': '헤어살롱, 네일아트, 마사지, 애터미 센터, 뷰티 부스, 코리안 다이소, 택배 서비스까지 — 한국 최고의 뷰티와 헬스케어를 경험하는 몰입형 공간입니다.',
      'floor2.cap': 'K-뷰티 & 웰니스',
      'floor3.label': 'K-푸드 & 드라마 · 595㎡',
      'floor3.title': 'K-푸드 & 드라마 존',
      'floor3.quote': '"내가 드라마의 주인공이 되는 순간."',
      'floor3.body': '중식, 일식, 라면, 치킨, 비빔밥, 한식, 삼겹살, 찌개 등 다양한 매장과 음료 바가 어우러진 푸드코트 — K-드라마 속 풍경에서 즐기는 미식.',
      'floor3.cap': 'K-푸드 & 드라마',
      ...
      'fork.investors.eyebrow': '투자자를 위한',
      ...
      'leasing.floors.eyebrow': '02 — 층별 공간',
      ...
      'contact.contact': '연락처',
      'contact.details': 'hello@thek-square.ph · +63 (추후 안내)',
